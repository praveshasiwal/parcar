...
public class VehicleController {
    ...
    public ResponseEntity<VehicleEntity> get(@PathVariable int vehicleNumber) {
    ...
    @RequestMapping(value = "/{vehicleNumber}", method = RequestMethod.PATCH, consumes = "application/json", produces = "application/json")
    public ResponseEntity<VehicleEntity> update(@PathVariable int vehicleNumber,@RequestBody VehicleEntity vehicleEntity) {
        VehicleEntity vehicleResult = vehicleService.update(vehicleNumber, vehicleEntity);
        ResponseEntity<VehicleEntity> responseEntity = new ResponseEntity<VehicleEntity>(vehicleResult, HttpStatus.OK);
        return responseEntity;
    }
